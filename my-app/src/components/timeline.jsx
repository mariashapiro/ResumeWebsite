                ...
                <div className="timeline-centered">
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Cyber Security Analyst @ Georgia Tech Office of Information Technology <span>Fall 2020 - Present</span></h2>
                        <p>• Monitored security alerts on Georgia Tech's network of <b>12,000</b> institute-owned endpoints and isolated and resolved any incoming security attacks</p>
                        <p>• Reviewed and remediated vulnerability reports using security tools such as <b>Splunk, FireEye,</b> and <b>ServiceNow</b></p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Residental IT Specialist @ Georgia Tech Office of Information Technology <span>Fall 2019 - Fall 2020</span></h2>
                        <p>• Responsible for all Georgia Tech affiliated accounts for password control and account permissions</p>
                        <p>• Provide networking support for 3 networks and over <b>6000 Access Points</b> for <b>15,000 devices</b></p>
                        <p>• Perform cabling for resident’s rooms including punching ethernet ports and evaluating data closets</p>
                      </div>
                    </div>
                  </article><article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      <div className="timeline-icon color-2">
                        <i className="icon-pen2" />
                      </div>
                      <div className="timeline-label">
                        <h2>Launch and Change Co-Op Intern Rotation 2 @ BMW <span>Spring 2020</span></h2>
                        <p>• Devised a <b>Java</b> and <b>VBA</b> program to compare BoM and Software to catch errors before the cars were on assembly</p>
                        <p>• Encouraged the program to be utilized by <b>3 international plants</b> and it is gathering traction by all BMW plants</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Launch and Change Co-Op Intern Rotation 1 @ BMW <span>Summer 2019</span></h2>
                        <p>• Automated daily tedious tasks from <b>2 hours to 15 minutes</b> using <b>Batch</b> files and <b>Java</b></p>
                        <p>• Utilized SAP, legacy systems, and VisView to assess the feasibility of engineering changes on the assembly line</p>
                        <p>• Began developing a change matrix using <b>SQL</b> and <b>Python</b> for engine and exhaust parts</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                      <h2>Innovative Technologies Intern @ The World Bank <span>Summer 2018</span></h2>
                        <p>• Researched <b>blockchain</b> and <b>artificial intelligence</b> solutions for use cases spanning worldwide</p>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Programming Counselor @ TIC <span>Summer 2017</span></h2>
                        <p>Summer camp encouraging students to excel in technology and programming while also emphasizing a balance in athletics and cooperation. Check out their website <a href={" http://ticcamp.com/"} target="_blank" rel="noopener noreferrer">here</a>.</p>
                        <p>• Supervised and <b>instructed 32 students</b>, 2nd – 8th grade in an all-day camp during 4-2-week rotations</p>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInUp">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Apprentice @ KID Museum <span>Fall 2015 & Spring 2016</span></h2>
                        <p>I served as a subject-matter expert for <b>STEM</b> curriculum and activities for <b>elementary schoolers</b> during this after school job in high school. Check out their website <a href={"https://kid-museum.org/"} target="_blank" rel="noopener noreferrer">here</a>.</p>
                      </div>
                    </div>
                  </article>
