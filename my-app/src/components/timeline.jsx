              ...
              <div className="timeline-centered">
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      <h2>
                        Cyber Security Analyst @ Georgia Tech Office of Information Technology <span>Fall 2020 - Spring 2022</span>
                      </h2>
                      <p>
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      <h2>
                        Explorer Intern @ Microsoft <span>Summer 2020</span>
                      </h2>
                      <p>
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      ...
                      <p>
                        • Developed curriculum containing skills in <b>Java, robotics, cybersecurity, Arduino, 3D printing, drones,</b> and
                        more
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      ...
                      <p>
                        ...
                        interest in data management, platforms, communications, and networking software for government solutions. I learned
                        key indicators to look for to value a start-up tech company. Check out their website{" "}
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInUp">
                  <div className="timeline-entry-inner">
                    ...
                    <div className="timeline-label">
                      ...
                      <p>
                        I served as a subject-matter expert for <b>STEM</b> curriculum and activities for <b>elementary schoolers</b> during
                        this after school job in high school. Check out their website{" "}
